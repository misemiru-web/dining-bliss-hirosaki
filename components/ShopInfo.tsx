  ...
  return (
    <section className="section information" id="information" aria-labelledby="information-title">
      <div className="container information-layout">
        <div className="information-heading" data-reveal data-reveal-from="right">
          <p className="eyebrow">SHOP &amp; ACCESS</p>
          <h2 id="information-title">Information</h2>
        </div>
        <div className="information-photo" data-reveal data-reveal-from="left" data-reveal-delay="1"><Image src={site.images.exterior} alt="夜のdining Bliss外観と丸い看板" fill sizes="(max-width: 899px) 100vw, 46vw" /></div>
        <div className="information-content">
          <dl className="information-list" data-reveal data-reveal-from="right" data-reveal-delay="1">
          ...
          <p className="information-note" data-reveal data-reveal-from="right" data-reveal-delay="2">※営業時間・予約方法等は営業提案用サンプル作成時点の公開情報をもとにしています。正式制作時に店舗確認のうえ更新します。</p>
          <div className="information-actions" data-reveal data-reveal-delay="2">
